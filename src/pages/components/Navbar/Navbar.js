...
export default function Navbar() {
  ...
  <div>
    ...
    <button className="inline-flex items-center text-white bg-black full-rounded  focus:outline-none rounded-3xl  text-base mt-4 md:mt-0 p-4 px-7 hover:bg-gray-500"> signup
